...
# right outer join, want all order details whether assoc w/ an order or not
# left outer join would get all of orders whether they had details or not
# just inner join would lose orphaned orders and order details

-- ----------------------------------------------
-- Validate that the Data was Inserted ----------
-- ----------------------------------------------
SELECT * FROM northwind_dw3.fact_orders;
SELECT id FROM northwind.orders;